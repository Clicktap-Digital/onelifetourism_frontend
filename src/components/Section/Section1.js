    ...
    <section className="bg-white">
      <div className="flex relative  flex-col  mx-auto max-w-screen-2xl px-4 py-10 sm:px-6 lg:flex h-full lg:px-8 lg:mt-20">
        ...
        <p className="text-sm mt-5 text-justify lg:w-[65%] lg:text-lg">
          ...
          tailored to meet every traveler's needs. From expert travel
          consultation services ensuring hassle-free travel arrangements to
          organizing thrilling and memorable activities at destinations
          worldwide, we are dedicated to crafting unforgettable experiences for
          our clients. Whether you're seeking adventure-packed holiday packages
          or tranquil getaways, our team is committed to curating the perfect
          itinerary just for you. Additionally, we cater to the B2B segment,
          providing tailored solutions for businesses seeking seamless travel
          arrangements for their employees or clients. With our expertise,
          dedication, and commitment to excellence, we're here to make your
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-20 w-full  place-items-start text-center lg:text-start">
          ...
          <div className="w-full">
            <div>
              ...
              <p className="mt-10 ">
                Our comprehensive consultancy services extend to over 40
                countries worldwide.
              </p>
            </div>
          </div>
